...
#
dest='coreutils-8.32'
# filtrowanie plikow o rozszerzeniu '.c', zawierajacy naglowek.
# -l wypisuje tylkon nazwy plikow bez tego wypisywaloby linie w pliku
# -x dopasowanie calej linii
# -r przezukuje podkatalogi
grep -lxr --include='*.c' '#include <stdio.h>' "$dest" | wc -l
